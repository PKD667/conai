...
6. before entering the <formal> section, be sure to lay out your program, and method for accomplishing the task in the <think> section.
7. The lambda expression should be well-typed and follow the syntax of typed lambda calculus.
Formal Typed Lambda Calculus Grammar: 
